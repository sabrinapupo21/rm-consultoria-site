    ...
    <>
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <em style={{ color: '#f5b832', fontStyle: 'italic' }}>projetos imobiliários</em>
              </h1>
              ...
              >
                Consórcio, financiamento imobiliário e crédito para construção com orientação especializada da RM Consultoria Imobiliária. Atendimento em todo o Brasil.
              </p>
              ...
              >
                ...
                <div
                  style={{
                    position: 'absolute',
                    inset: 0,
                    background: 'linear-gradient(180deg, transparent 50%, rgba(13,69,131,0.5) 100%)',
                  }}
                />
              </div>
              {/* Floating badge */}
      ...
      <section style={{ backgroundColor: '#f8f7f4', padding: '96px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <SectionTitle>Cada projeto tem<br />a solução certa</SectionTitle>
          ...
          <div style={{ marginTop: 48, textAlign: 'center' }}>
            <a href={WHATSAPP} target="_blank" rel="noopener noreferrer" style={btnNavy}>
              Falar com a RM →
            </a>
          </div>
        </div>
      ...
      <section
        style={{
          backgroundColor: '#0d4583',
          padding: '96px 24px',
          backgroundImage: 'radial-gradient(ellipse 70% 90% at 100% 50%, rgba(232,150,10,0.08) 0%, transparent 60%)',
        }}
      >
        <div
          style={{
        ...
        >
          <div>
            ...
            >
              Sem juros — só taxa de administração, diluída nas parcelas. Você define o valor da carta, o prazo e a estratégia de contemplação, com acompanhamento da RM em cada etapa.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginBottom: 40 }}>
              {[
                ...
                <div key={item} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <span style={{ fontFamily: 'Outfit, sans-serif', fontSize: 16, color: 'rgba(255,255,255,0.85)' }}>
                    {item}
                  </span>
                </div>
              ))}
          ...
          >
            <div style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 600, fontSize: 13, color: '#f5b832', letterSpacing: '1.2px', textTransform: 'uppercase', marginBottom: 32 }}>
              Por que consórcio?
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
              {[
                { label: 'Juros no consórcio', value: 'Zero', sub: 'Só taxa de administração' },
                { label: 'Uso do FGTS', value: 'Sim', sub: 'Lance, amortização ou quitação' },
                { label: 'Valor da carta', value: 'Flexível', sub: 'Você escolhe o quanto precisa' },
                { label: 'Contemplação', value: 'Por sorteio ou lance', sub: 'Estratégia personalizada com a RM' },
              ].map((stat) => (
                <div key={stat.label} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: 20 }}>
                  <div>
                    <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: 13, color: 'rgba(255,255,255,0.5)', marginBottom: 4 }}>{stat.label}</div>
                    <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>{stat.sub}</div>
                  </div>
                  <div style={{ fontFamily: 'Fraunces, serif', fontWeight: 700, fontSize: 18, color: '#f5b832', textAlign: 'right', maxWidth: 140 }}>
                    {stat.value}
                  </div>
                </div>
              ))}
      ...
      <section style={{ backgroundColor: '#ffffff', padding: '80px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', flexWrap: 'wrap', gap: '48px 80px', alignItems: 'center' }}>
          <div style={{ flex: '1 1 320px' }}>
            <SectionLabel>Precisa do imóvel agora?</SectionLabel>
            <h2 style={sectionH2}>Conheça as opções de financiamento</h2>
            <p style={bodyText}>
              Como correspondente bancária CAIXA, a RM ajuda você a entender as linhas disponíveis — incluindo condições especiais como o Pró-Cotista — e encontrar a que melhor se encaixa no seu momento.
            </p>
      ...
      <section style={{ backgroundColor: '#f8f7f4', padding: '80px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', flexWrap: 'wrap', gap: '48px 80px', alignItems: 'center', flexDirection: 'row-reverse' }}>
          <div style={{ flex: '1 1 320px' }}>
            <SectionLabel>Já tem o terreno?</SectionLabel>
            <h2 style={sectionH2}>A RM também ajuda você a planejar sua construção</h2>
            <p style={bodyText}>
              Crédito para quem quer construir no próprio terreno, com orientação especializada da RM. Da aquisição do terreno até a obra completa — incluindo a compra do terreno para quem ainda não tem.
            </p>
      ...
      >
        <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center' }}>
          ...
          >
            Cada projeto imobiliário tem uma necessidade diferente. Conte pra RM o que você pretende realizar e receba orientação sobre as possibilidades — sem compromisso.
          </p>
          <a href={WHATSAPP} target="_blank" rel="noopener noreferrer" style={btnNavy}>
      ...
      <section style={{ backgroundColor: '#ffffff', padding: '96px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            {[
              { step: '01', title: 'Entendemos seu projeto', desc: 'Conhecemos seus objetivos, prazo e situação financeira.' },
              { step: '02', title: 'Analisamos suas possibilidades', desc: 'Mapeamos as opções disponíveis para o seu perfil.' },
              { step: '03', title: 'Apresentamos as melhores alternativas', desc: 'Simulações claras, sem jargão, para você comparar.' },
              { step: '04', title: 'Você decide, com orientação', desc: 'A escolha é sua, com a RM ao seu lado em cada etapa.' },
            ].map((item) => (
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <h2 style={sectionH2}>Experiência e conhecimento para orientar seu projeto imobiliário</h2>
            <p style={{ ...bodyText, marginBottom: 20 }}>
              À frente da RM Consultoria Imobiliária está <strong>Renata Maia</strong>, profissional com ampla experiência em crédito imobiliário, atuando como correspondente bancária CAIXA em Araçatuba/SP.
            </p>
            <p style={{ ...bodyText, marginBottom: 36 }}>
              Ao longo de sua trajetória, Renata construiu sua atuação ajudando clientes a encontrar caminhos para aquisição, construção e planejamento de seus projetos imobiliários — hoje atendendo clientes em todo o Brasil.
            </p>
            ...
            {[
              ...
              >
                <div style={{ display: 'flex', gap: 4, marginBottom: 18 }}>
                  {[1, 2, 3, 4, 5].map((s) => (
                    <span key={s} style={{ color: '#f5b832', fontSize: 16 }}>★</span>
                  ))}
                </div>
                <p
                  style={{
                ...
                <div>
                  <div style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 600, fontSize: 15, color: '#ffffff' }}>
                    {t.name}
                  </div>
                  <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: 13, color: 'rgba(255,255,255,0.45)' }}>
                    {t.city}
                  </div>
                </div>
              </div>
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        ;(e.currentTarget as HTMLElement).style.boxShadow = '0 16px 40px rgba(13,69,131,0.15)'
      }}
      onMouseLeave={(e) => {
...
const sectionH2: React.CSSProperties = {
  fontFamily: 'Fraunces, serif',
  fontWeight: 700,
  fontSize: 'clamp(26px, 3.5vw, 38px)' as any,
  color: '#111827',
  lineHeight: 1.15,
  letterSpacing: '-0.5px',
  marginBottom: 16,
