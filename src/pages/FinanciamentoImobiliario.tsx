...
const WHATSAPP = 'https://wa.me/5518999999999?text=Olá%2C%20Renata!%20Gostaria%20de%20saber%20mais%20sobre%20financiamento%20imobiliário.'
    ...
    <>
      ...
      <section
        style={{
          ...
          backgroundImage: 'radial-gradient(ellipse 70% 80% at 90% 40%, rgba(13,100,200,0.25) 0%, transparent 60%)',
          paddingTop: 68,
          minHeight: '70vh',
          display: 'flex',
          alignItems: 'center',
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '72px 24px', width: '100%' }}>
          <div style={{ maxWidth: 680 }}>
            ...
            >
              ...
              <em style={{ color: '#f5b832', fontStyle: 'italic' }}>correspondente CAIXA</em>
            </h1>
            ...
            >
              Renata Maia ajuda você a entender as linhas de crédito disponíveis e encontrar a condição mais adequada ao seu momento — com acompanhamento em todas as etapas até a aprovação.
            </p>
            ...
            <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
              ...
              <a href={WHATSAPP} target="_blank" rel="noopener noreferrer" style={btnGhost}>
                Falar no WhatsApp
              </a>
            </div>
          </div>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          >
            <div>
              ...
              >
                Como correspondente bancária CAIXA, a RM realiza a análise do seu perfil de crédito, compara as linhas e condições disponíveis, e te acompanha em todas as etapas até a aprovação.
              </p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                {[
                  ...
                  <div key={item} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <span style={{ fontFamily: 'Outfit, sans-serif', fontSize: 16, color: '#374151' }}>
                      {item}
                    </span>
                  </div>
                ))}
            ...
            <div style={{ borderRadius: 20, overflow: 'hidden', backgroundColor: '#e8f0fa', aspectRatio: '4/3' }}>
              <img
      ...
      >
        <div style={{ maxWidth: 560, margin: '0 auto' }}>
          ...
          >
            Fale com a RM sobre financiamento imobiliário e receba orientação personalizada.
          </p>
          <a href={WHATSAPP} target="_blank" rel="noopener noreferrer" style={btnAmber}>
            Falar com a RM sobre financiamento →
          </a>
          <div style={{ marginTop: 24 }}>
            <Link to="/" style={{ fontFamily: 'Outfit, sans-serif', fontSize: 14, color: 'rgba(255,255,255,0.45)', textDecoration: 'none' }}>
              ← Voltar para início
            </Link>
          </div>
        </div>
