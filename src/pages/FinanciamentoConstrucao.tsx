...
const WHATSAPP = 'https://wa.me/5518999999999?text=Olá%2C%20Renata!%20Quero%20saber%20mais%20sobre%20financiamento%20para%20construção.'
    ...
    <>
      ...
      <section
        style={{
          ...
          backgroundImage: 'radial-gradient(ellipse 60% 80% at 20% 60%, rgba(232,150,10,0.1) 0%, transparent 55%)',
          paddingTop: 68,
          minHeight: '70vh',
          display: 'flex',
          alignItems: 'center',
      ...
      >
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '72px 24px', width: '100%' }}>
          <div
            style={{
              display: 'grid',
          ...
          >
            <div>
              ...
              >
                Financiamento para Construção: já tem o terreno?{' '}
                <em style={{ color: '#f5b832', fontStyle: 'italic' }}>Vamos planejar sua obra.</em>
              </h1>
              ...
              >
                Crédito para quem quer construir no próprio terreno — ou ainda precisa adquirir o terreno — com orientação especializada da RM. Da planta à entrega das chaves.
              </p>

              <a href={WHATSAPP} target="_blank" rel="noopener noreferrer" style={btnAmber}>
                Falar sobre minha construção →
              </a>
            </div>

            <div style={{ borderRadius: 20, overflow: 'hidden', backgroundColor: '#0a3870', aspectRatio: '4/3' }}>
              <img
            ...
            {[
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  ;(e.currentTarget as HTMLElement).style.boxShadow = '0 12px 32px rgba(13,69,131,0.12)'
                }}
                onMouseLeave={(e) => {
      ...
      <section style={{ backgroundColor: '#ffffff', padding: '96px 24px' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 64 }}>
            ...
            >
              O financiamento para construção tem características próprias — a RM orienta você em cada etapa com clareza.
            </p>
          </div>
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  padding: '32px 0',
                  borderBottom: i < 3 ? '1px solid rgba(13,69,131,0.1)' : 'none',
                }}
              >
                <div
                  style={{
                ...
                >
                  <span style={{ fontFamily: 'Fraunces, serif', fontWeight: 700, fontSize: 17, color: '#ffffff' }}>
                    {item.step}
                  </span>
                </div>
                <div>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              As regras de financiamento para construção — como necessidade de terreno quitado, percentual financiado e etapas de liberação — variam conforme a linha contratada e seu perfil de crédito. A RM analisa seu caso e apresenta as opções reais disponíveis para você, sem generalizar.
            </p>
          </div>
        </div>
      </section>
            ...
            items={[
              {
                ...
                a: 'Depende da linha de crédito. Em algumas modalidades, o terreno próprio e quitado é exigido. Em outras, é possível incluir a aquisição do terreno no financiamento. A RM verifica qual se aplica ao seu caso.',
              },
              {
                q: 'O crédito é liberado de uma vez?',
                a: 'Geralmente não. O crédito para construção é liberado em parcelas conforme o andamento e vistoria das etapas da obra.',
              },
              {
                q: 'Posso financiar a compra do terreno e a construção juntos?',
                a: 'Sim, em algumas linhas de crédito é possível incluir tanto a aquisição do terreno quanto a construção em um único financiamento. Consulte a RM para saber as condições atuais.',
              },
              {
                q: 'Posso usar o FGTS nessa modalidade?',
                a: 'Depende da linha contratada e das regras vigentes do FGTS. A RM orienta sobre as possibilidades para o seu perfil.',
              },
              {
      ...
      <section
        style={{
          ...
          padding: '96px 24px',
          textAlign: 'center',
          backgroundImage: 'radial-gradient(ellipse 70% 80% at 50% 100%, rgba(232,150,10,0.12) 0%, transparent 55%)',
        }}
      >
        <div style={{ maxWidth: 560, margin: '0 auto' }}>
          ...
          >
            Conte pra RM o seu projeto de construção e receba orientação personalizada, sem compromisso.
          </p>
          <a href={WHATSAPP} target="_blank" rel="noopener noreferrer" style={btnAmberLarge}>
            Conversar sobre financiamento de construção →
          </a>
          <div style={{ marginTop: 24 }}>
            <Link to="/" style={{ fontFamily: 'Outfit, sans-serif', fontSize: 14, color: 'rgba(255,255,255,0.4)', textDecoration: 'none' }}>
              ← Voltar para início
            </Link>
          </div>
        </div>
    ...
    <div>
      {items.map((item, i) => (
        <div key={i} style={{ borderBottom: '1px solid rgba(13,69,131,0.1)' }}>
          ...
          >
            <span style={{ fontFamily: 'Fraunces, serif', fontWeight: 600, fontSize: 17, color: '#111827', lineHeight: 1.35 }}>
              {item.q}
            </span>
            <span
              style={{
          ...
          {openIdx === i && (
            <p style={{ fontFamily: 'Outfit, sans-serif', fontSize: 16, color: '#4b5563', lineHeight: 1.7, paddingBottom: 22 }}>
              {item.a}
            </p>
          )}
        </div>
...
const sectionH2: React.CSSProperties = {
  fontFamily: 'Fraunces, serif',
  fontWeight: 700,
  fontSize: 'clamp(26px, 4vw, 40px)' as any,
  color: '#111827',
  lineHeight: 1.15,
  letterSpacing: '-0.5px',
}
