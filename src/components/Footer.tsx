...
export default function Footer() {
  return (
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <div style={{ fontSize: 14, lineHeight: 1.7, marginBottom: 20 }}>
            Orientação especializada em crédito imobiliário — consórcio, financiamento e construção. Sediada em Araçatuba (SP), atendendo clientes em todo o Brasil.
          </div>
        ...
        <div>
          ...
          <nav style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            <Link to="/consorcio-imobiliario" style={footerLink}>Consórcio Imobiliário</Link>
            <Link to="/financiamento-imobiliario" style={footerLink}>Financiamento Imobiliário</Link>
            <Link to="/financiamento-construcao" style={footerLink}>Financiamento para Construção</Link>
          </nav>
        </div>
      ...
      >
        <span>© 2025 RM Consultoria Imobiliária — Renata Maia. Todos os direitos reservados.</span>
